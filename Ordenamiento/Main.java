...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] arrToBubbleShort = {351, 33, 42, 110, 14, 919, 27, 1144, 216, 311, 0};
        ...
        System.out.println("Antes: " + Arrays.toString(arrToBubbleShort));
        int[] arrBubbleSort = BubbleSort.bubbleSort(arrToBubbleShort);
        System.out.println("Ahora: " + Arrays.toString(arrToBubbleShort));
        System.out.println();
    }
}
